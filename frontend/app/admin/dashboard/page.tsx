    ...
    async function loadDashboard() {
      try {
        const [
          ...
          fetch(`${API_URL}/api/matches/upcoming`),
        ]);
  ...
  return (
    <main className="min-h-screen bg-[#063b32] text-[#f4f0e5]">
      <div className="flex min-h-screen">
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-50 bg-[#042e28] lg:hidden">
                  ...
                  {liveMatches.length === 0 ? (
                    <div className="flex min-h-[220px] flex-col items-center justify-center text-center">
                      <div className="flex h-14 w-14 items-center justify-center border border-white/10">
                        <Activity size={24} className="text-white/25" />
                      </div>
                        ...
                        >
                          ...
                          <div className="mt-5 grid grid-cols-[1fr_auto] items-center gap-5">
                            ...
                            <Link
                              ...
                              className="flex h-11 w-11 items-center justify-center border border-[#ff625b] text-[#ff625b] transition-colors hover:bg-[#ff625b] hover:text-[#041f1b]"
