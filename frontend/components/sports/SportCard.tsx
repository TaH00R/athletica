...
export default function SportCard({ sport }: SportCardProps) {
  const image = getSportImage(sport.name);
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 px-5 py-5">
        <div className="min-w-0">
          <p className="mono-font mb-1 text-[9px] font-bold uppercase tracking-[0.18em] text-[#f4b93f]">
            Sport #{String(sport.displayOrder).padStart(2, "0")}
          </p>
